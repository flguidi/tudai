...
public class DirectedGraph<V, E> {
    ...
    /**
     * Obtiene la arista que conecta dos vértices especificados.
     *
     * @param vertexId1 ID del vértice de origen.
     * @param vertexId2 ID del vértice de destino.
     * @return Arista que conecta los vértices especificados.
     */
    public Edge<E> getEdge(int vertexId1, int vertexId2) {
        return vertices.get(vertexId1).getEdgeToVertex(vertexId2);
    }
